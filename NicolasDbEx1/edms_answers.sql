...
-- ITEM #2
select emp_name as "Managers who have a salary between 1500-2500"
from employees
...
select emp_name as "Salesmen who have an income above 2000"
from employees_cte
where job_name = 'SALESMAN' and income > 2000.00;

-- ITEM 4
select emp_name as "Employees that work in Sydney"
